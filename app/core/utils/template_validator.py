...
class TemplateValidator:
    ...
    def validate_template(html_content: str) -> Dict[str, any]:
        ...
        html_valid, html_errors = TemplateValidator.validate_html_structure(
            html_content)
        if not html_valid:
        ...
        # Variable validation
        var_valid, var_errors = TemplateValidator.validate_variables(
            html_content)
        if not var_valid:
        ...
        # Extract variables
        results['variables'] = TemplateValidator.extract_variables(
            html_content)
